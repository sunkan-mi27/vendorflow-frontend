    ...
    <div className="landing">
      ...
      <section className="platform-section">
        ...
        <div className="platform-row">
          <Link to="/register?platform=whatsapp" className="platform-icon">
          ...
          <Link to="/register?platform=instagram" className="platform-icon">
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <Link to="/register?platform=tiktok" className="platform-icon">
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <Link to="/register?platform=twitter" className="platform-icon">
            <svg viewBox="0 0 24 24" fill="currentColor">
